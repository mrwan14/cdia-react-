...
export default function MobileAppsPortfolio() {
  return (
    <div className="WebsiesPortfolio">
      <div className="text-center  linear-bg">
        <h1 className="heading"> MOBILE APPLICATIONS</h1>{" "}
      </div>
      <div className="container">
        <div className="row p-5">
          <div className="col-md-3 p-5">
            ...
            <h1 className="ms-4 mb-5">Mobile Appplications Portfolio</h1>
