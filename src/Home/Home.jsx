...
import mission from "../images/z.png";
            ...
            <div className="col-md-5  text-center bg-black text-white rounded-5  my-3">
              ...
              <div className="vision-desc">
                <ReadMoreReact
                  text="At
                  Cdia
                , our vision is to become a global leader in technology and marketing, revolutionizing how businesses succeed. We aim to blend innovative software solutions with creative marketing strategies to set new standards of excellence. By using the latest technologies like AI and IoT, we want to create game-changing solutions that benefit industries worldwide.
                    ...
                    <div class="flip-card-back d-flex  align-items-center">
                      <div>
                        ...
                        <p className=" text-white p-5">
                          we design and develop mobile apps that delight your
                          users and grow your business. enterprise-grade
                          development combined with outstanding design
                        </p>
                  ...
                  <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back d-flex  align-items-center">
                      <div>
                        ...
                        <p className=" text-white p-5">
                          our team has a successful track record of helping
                          brands scale profitably based on high-performing
                          strategies
                        </p>
                        <a href="mobileWorks.html" className="btn">
                          learn more
              ...
              <div className="col-md-6 col-lg-4  col-sm-12">
                ...
                <div className="box  ">
                  <div class="flip-card-inner">
                    ...
                    <div class="flip-card-back d-flex  align-items-center">
                      <div>
                        <h1 className="">Seo Services</h1>
                        <p className=" text-white p-5">
                          through the seo service,you can place your website at
                          the top of websites
                        </p>
                        <a href="mobileWorks.html" className="btn">
                          learn more
                ...
                <div class="d-flex gap-2">
                  <div class="col-md-3 ">
                    <img
                      src={client1}
                      alt=""
                      class="   cursor-img-container "
                    />
                  </div>
                  <div class="col-md-3 ">
                    <img src={client2} alt="" class="  cursor-img-container" />
                  </div>
                  <div class="col-md-3 ">
                    <img src={client3} alt="" class="  cursor-img-container" />
                  </div>
                  <div class="col-md-3 ">
                    <img src={client4} alt="" class=" cursor-img-container" />
                  </div>
                </div>
              </div>{" "}
            </div>
          ...
          <Carousel.Item className="my-5   ">
            <div className="d-flex justify-content-center">
              ...
              <div class="row w-75 ">
                <div class="d-flex gap-2">
                  <div class="col-md-3">
                    <img src={client5} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client6} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client7} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client8} alt="" class="cursor-img-container" />
                  </div>
                </div>
              </div>{" "}
            </div>
          ...
          <Carousel.Item className="my-5   ">
            <div className="d-flex justify-content-center">
              ...
              <div class="row w-75 ">
                <div class="d-flex gap-2">
                  <div class="col-md-3">
                    <img src={client9} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client10} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client11} alt="" class="cursor-img-container" />
                  </div>
                  <div class="col-md-3">
                    <img src={client12} alt="" class="cursor-img-container" />
                  </div>
                </div>
              </div>{" "}
            </div>
